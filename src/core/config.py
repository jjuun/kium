...
class Config:
    ...
    # 키움증권 API 설정
    KIWOOM_APPKEY = os.getenv(
        "KIWOOM_APPKEY", "a1FNKyL3TD9HSVujmYqoCeZpHYiAOoERGyd7eiCSDos"
    )
    KIWOOM_SECRETKEY = os.getenv(
        "KIWOOM_SECRETKEY", "qd1MDzpi55OLdCc8uNnf_LRMN9TaIi27PsM8QsE1OU8"
    )
