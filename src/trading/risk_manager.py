...
class RiskManager:
    ...
    def remove_position(self, symbol, exit_price, timestamp=None):
        ...
        try:
            ...
            logger.info(f"포지션 제거: {symbol} - 수익/손실: {profit_loss:,}원 ({profit_loss_percent:+.2f}%)")
    ...
    def get_portfolio_summary(self):
        ...
        try:
            ...
            if self.trade_history:
                ...
                total_invested = sum(trade['entry_price'] * trade['quantity'] for trade in self.trade_history)
                if total_invested > 0:
            ...
            summary = {
                ...
                'losing_trades': len([t for t in self.trade_history if t['profit_loss'] < 0])
            }
    ...
    def check_risk_limits(self, symbol, quantity, price):
        ...
        try:
            ...
            if position_value > self.max_position_size:
                logger.warning(f"포지션 크기 한도 초과: {position_value:,}원 > {self.max_position_size:,}원")
    ...
    def get_trade_history(self, symbol=None, days=None):
        ...
        try:
            ...
            if days:
                ...
                filtered_history = [t for t in filtered_history if t['exit_time'] >= cutoff_date]
